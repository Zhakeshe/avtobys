...
class AppColors {
  ...
  static const success = Color(0xFF89C83F);
  static const pink = Color(0xFFD71E6F);
  static const violet = Color(0xFF7B62F6);
}

const appCardShadow = [
  BoxShadow(color: Color(0x120D1B2A), blurRadius: 26, offset: Offset(0, 10)),
];
