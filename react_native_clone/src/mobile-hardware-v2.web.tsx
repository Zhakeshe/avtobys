...
export function QrScannerPaymentScreen(props: HardwareProps) {
  ...
  const frameSize = Math.max(200, Math.min(280, Math.round(Math.min(winW - 36, winH * 0.36))));
  const frameTop = Math.max(32, Math.min(100, Math.round(winH * 0.07)));
  ...
  return (
    <View style={styles.scanner}>
      ...
      <SafeAreaView style={styles.flex}>
        ...
        <View style={[styles.frame, { width: frameSize, height: frameSize, marginTop: frameTop }]} />
